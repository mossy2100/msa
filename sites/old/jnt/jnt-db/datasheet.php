...
<tr>
<td width="50%" bgcolor="#ffcc00">LOCALITY
</td>
...
<img id="img<?php echo $data['image_general1']; ?>" 
alt="" 
src="/images/<?php echo $data['image_general1']; ?>" pbshowcaption="true" pbcaption="Island Lagoon "
class="PopBoxImageSmall" title="Click to magnify/shrink" 
pbshowpopbar="true"
style="width: 150px;
height: 120px;" 
onclick="Pop(this,50,'PopBoxImageLarge');" pbshowpopbar="true" />
...
<?PHP if(!$data['image_general2'])
	{echo"";} else 
	{?>

<img  id="img<?php echo $data['image_general2']; ?>" alt=""
src="/images/<?php echo $data['image_general2']; ?>"
pbshowcaption="true"
pbcaption=""

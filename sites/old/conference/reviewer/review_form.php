...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
	...
	{
		echo " <font color=\"#FF0000\"> Could not read author table. Try <a href='/conference/reviewer/review_form.php?paperid=".$_POST["paperid"]."'>again</a>?</font>" ;
	}
	  ?></h4></td>
    </tr>
    <?php
    ...
    <tr>
      <td><table width="90%" border="1" cellpadding="0" cellspacing="2">
          ...
          <tr>
            ...
            <td align="center"><input name="appropriateness" type="radio" value="1"
			<?php if ( isset ( $_POST["appropriateness"] ) )
				{
					if ($_POST["appropriateness"] == 1)
						echo "checked";
				}
				else
				{
          ...
          <tr>
            <td>Originality</td>
            <td align="center"><input name="originality" type="radio" value="1"
			<?php if ( isset ( $_POST["originality"] ) )
				{
					if ($_POST["originality"] == 1)
						echo "checked";
				}
				else
				{
          ...
          <tr>
            ...
            <td align="center"><input name="tech_strength" type="radio" value="1"
						<?php if ( isset ( $_POST["tech_strength"] ) )
				{
					if ($_POST["tech_strength"] == 1)
						echo "checked";
				}
				else
				{
          ...
          <tr>
			...
			<?php if ( isset ( $_POST["presentation"] ) )
				{
					if ($_POST["presentation"] == 1)
						echo "checked";
				}
				else
				{
          ...
          <tr>
            ...
            <td align="center"><input name="overall" type="radio" value="1"
			<?php if ( isset ( $_POST["overall"] ) )
				{
					if ($_POST["overall"] == 1)
						echo "checked";
				}
    ...
    <tr>
	      <td><p><strong>Comments for Chair (not sent to authors)</strong><font color="#FF0000"><?php echo $error_array["commentsadmin"][0] ?></font></p>
        <p>

...
*/
	...
	{
		header("Location: reviewer_home.php") ; // redirect to the reviewer home (instead of the admin home)
		exit ;
	}
	...
	if ( count ( $error_array ) == 0 && count ( $_POST ) > 0 )
	{
		...
		else
		{
			...
			do_html_header("Change password failed" , &$err_message );
			$err_message .= "<br><br> Try <a href='/conference/reviewer/change_pwd.php'>Again</a>? <br>\n" ;
		}
	}
	else
	{

...
{	
	...
	{	
		...
		{		
			...
			echo " Your personal information was updated successfully. <br><br><a href='/conference/user/edit_details.php'>View</a> your updated details?<br>\n" ;
		...
		else
		{
			...
			$err_message .= "<br><br> Try <a href='/conference/user/edit_details.php'>again</a>?<br>\n" ;
		}
	}
...
else 
{
	...
	{	
		...
		if (!$db)
		{
			...
			$err_message .= "<br><br> Try <a href='/conference/user/edit_details.php'>again</a>?" ;
			do_html_footer(&$err_message);
			exit;
		}

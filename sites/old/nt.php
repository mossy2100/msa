...
NORTHERN TERRITORY BRANCH HOMEPAGE
</span>
<br>
<br>
      
<span class="bodytext">
For more information on branch activities contact - <br>
        <br>

Northern Territory Branch Coordinator <br>
Mars Society of Australia <br>
<script> email('nt','marssociety.org.au','email')</script>  <br>
...
<?php
$SQL="SELECT DATE_FORMAT(date, '%D %M, %Y') as newdate, headline, article, thumb_gallery, region FROM headlines WHERE region like '%Northern Territory%' ORDER BY date DESC";

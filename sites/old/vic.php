...
Victorian Branch Coordinator <br>
Mars Society of Australia <br>
<script> email('vic','marssociety.org.au','email')</script>  <br>
...
<?php
$SQL="SELECT DATE_FORMAT(date, '%D %M, %Y') as newdate, headline, article, thumb_gallery, region FROM headlines WHERE region like '%Victoria%' ORDER BY date DESC";

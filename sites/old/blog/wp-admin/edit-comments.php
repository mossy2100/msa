...
<p><a href="/blog/wp-admin/?mode=view"><?php _e('View Mode') ?></a> | <a href="/blog/wp-admin/?mode=edit"><?php _e('Mass Edit Mode') ?></a></p>
<?php
...
?>
  <tr id="comment-<?php echo $comment->comment_ID; ?>" class='<?php echo $class; ?>'>
	...
	echo "<a href='/blog/wp-admin/comment.php?action=editcomment&amp;c=$comment->comment_ID' class='edit'>" .  __('Edit') . "</a>"; } ?></td>
    <td><?php if ( current_user_can('edit_post', $comment->comment_post_ID) ) {

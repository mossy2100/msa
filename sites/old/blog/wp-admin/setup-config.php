...
<body>
<h1 id="logo"><img alt="WordPress" src="/blog/wp-admin/images/wordpress-logo.png" /></h1>
<?php
// Check if wp-config.php has been created
if (file_exists('../wp-config.php'))
	die("<p>The file 'wp-config.php' already exists. If you need to reset any of the configuration items in this file, please delete it first. You may try <a href='/blog/wp-admin/install.php'>installing now</a>.</p></body></html>");
...
<p>In all likelihood, these items were supplied to you by your ISP. If you do not have this information, then you will need to contact them before you can continue. If you&#8217;re all ready, <a href="/blog/wp-admin/setup-config.php?step=1">let&#8217;s go</a>! </p>
<?php
	break;
...
?>
<p>All right sparky! You've made it through this part of the installation. WordPress can now communicate with your database. If you are ready, time now to <a href="/blog/wp-admin/install.php">run the install!</a></p>
<?php
	break;
}
?>

...
foreach ($recents as $recent) :
	echo "<li><a href='/blog/wp-admin/templates.php?file=" . attribute_escape($recent) . "'>" . wp_specialchars(get_file_description(basename($recent))) . "</a></li>";
endforeach;
echo '</ol>';
endif;
?>
...
<ul>
	<?php foreach ($common_files as $common_file) : ?>
		<li><a href="/blog/wp-admin/templates.php?file=<"><?php echo get_file_description($common_file); ?></a></li>
	<?php endforeach; ?>
</ul>
</div>
<?php if (!$error) { ?>

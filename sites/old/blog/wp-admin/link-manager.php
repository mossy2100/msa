...
<p><?php _e('Here you <a href="/blog/wp-admin/link-add.php">add links</a> to sites that you visit often and share them on your blog. When you have a list of links in your sidebar to other blogs, it&#8217;s called a &#8220;blogroll.&#8221;'); ?></p>
			...
			switch($column_name) {
				...
				case 'categories':
					...
					foreach ($link->link_category as $category) {
						...
						if ( $cat_id != $category )
							$cat_name = "<a href='/blog/wp-admin/link-manager.php?cat_id=$category'>$cat_name</a>";
						$cat_names[] = $cat_name;
					}
				...
				case 'visible':
					...
					break;
				case 'action':
					echo '<td><a href="/blog/wp-admin/link.php?link_id='.$link->link_id.'&amp;action=edit" class="edit">'.__('Edit').'</a></td>';

...
function _cat_row( $category, $level, $name_override = false ) {
	...
	if ( current_user_can( 'manage_categories' ) ) {
		$edit = "<a href='/blog/wp-admin/categories.php?action=edit&amp;cat_ID=$category->cat_ID' class='edit'>".__( 'Edit' )."</a></td>";
	...
	$posts_count = ( $category->category_count > 0 ) ? "<a href='/blog/wp-admin/edit.php?cat=$category->cat_ID'>$category->category_count</a>" : $category->category_count;
...
?>
  <tr id='page-<?php echo $id; ?>' class='<?php echo $class; ?>'> 
    ...
    <td><?php if ( current_user_can( 'edit_page', $id ) ) { echo "<a href='/blog/wp-admin/page.php?action=edit&amp;post=$id' class='edit'>" . __( 'Edit' ) . "</a>"; } ?></td> 
...
function user_row( $user_object, $style = '' ) {
	...
	$r .= "\n\t\t<td align='center'>";
	if ( $numposts > 0 ) {
		$r .= "<a href='/blog/wp-admin/edit.php?author=$user_object->ID' title='" . __( 'View posts by this author' ) . "' class='edit'>";
...
function browse_happy() {
	...
	echo '
		<p id="bh" style="text-align: center;"><a href="http://browsehappy.com/" title="'.$getit.'"><img src="/blog/wp-admin/images/browse-happy.gif" alt="Browse Happy" /></a></p>
		';
}

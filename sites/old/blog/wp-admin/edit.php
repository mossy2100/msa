...
<?php if ($drafts) { ?>
	...
	foreach ($drafts as $draft) {
		...
		echo "<a href='/blog/wp-admin/post.php?action=edit&amp;post=$draft->ID' title='" . __('Edit this draft') . "'>$draft->post_title</a>";
		++$i;
		}
	?>
	.</p>
...
foreach($posts_columns as $column_name=>$column_display_name) {
	...
	case 'comments':
		...
		<td style="text-align: center">
			<?php comments_number(__('0'), "<a href='/blog/wp-admin/edit.php?p=$id&amp;c=1'>" . __('1') . '</a>', "<a href='/blog/wp-admin/edit.php?p=$id&amp;c=1'>" . __('%') . '</a>') ?>
			</td>
		<?php
		break;
	...
	case 'control_edit':
		?>
		<td><?php if ( current_user_can('edit_post',$post->ID) ) { echo "<a href='/blog/wp-admin/post.php?action=edit&amp;post=$id' class='edit'>" . __('Edit') . "</a>"; } ?></td>
		<?php
		break;
...
if ( current_user_can('edit_post', $comment->comment_post_ID) ) {
	echo " <a href='/blog/wp-admin/comment.php?action=editcomment&amp;c=".$comment->comment_ID."'>" .  __('Edit') . '</a>';

...
<head>
	...
	<link rel="stylesheet" href="/blog/wp-admin/install.css?version=<" type="text/css" />
	<?php if ( ('rtl' == $wp_locale->text_direction) ) : ?>
	<link rel="stylesheet" href="/blog/wp-admin/install-rtl.css?version=<" type="text/css" />
	<?php endif; ?>
</head>
<body>
...
<h2 class="step"><a href="/blog/wp-admin/install.php?step=1"><?php _e('First Step &raquo;'); ?></a></h2>
<?php
		break;
	case 1:
?>
...
<dl>
	...
	<dt><?php _e('Login address'); ?></dt>
		<dd><a href="/blog/wp-admin/../wp-login.php">wp-login.php</a></dd>
</dl>

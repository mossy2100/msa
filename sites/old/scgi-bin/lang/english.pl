...
%msg = (
   ...
   articles_waitingC => 'Articles, to be published:',
    ask_reply_notify => 'Do you want a notification e-mail if someone replies to this topic?',
             authorC => 'Author:',
 ...
 confirm_pass_change => 'Confirm password change for',
     ...
     forum_messagesC => 'Forum messages:',
      ...
      forum_threadsC => 'Forum threads:',
       ...
       list_articles => 'Click on an image to list all articles in this topic.',
        ...
        edit_profile => 'Edit profile',
         ...
         forum_admin => 'Forum Admin',
              forums => 'Forums',
                ...
                home => 'Home',
            im_index => 'IM Index',
        latest_posts => 'Latest Forumposts',
...
# Info texts.
%inf = (
     account_created => 'Hello, you\'ve just created an account at '.$cfg{pagename}.'! Please log in at '.$cfg{pageurl}.'/login.'.$cfg{ext}.' with the info shown below and edit your user profile.',
         change_pass => 'Please log in at '.$cfg{pageurl}.'/login.'.$cfg{ext}.' and change your password.',
 change_required_msg => 'If the password change is not required, simply log in at '.$cfg{pageurl}.'/login.'.$cfg{ext}.' to cancel the request.',
   confirmation_sent => 'Confirmation email sent to:',
          ...
          link_saved => 'Your link submission has been saved. You can <a href=>\''.$cfg{pageurl}.'/links.'.$cfg{ext}.'?op=addlink\'>add another link</a> or <a href=\''.$cfg{pageurl}.'/links.'.$cfg{ext}.'\'>browse the link categories</a>.',
 ...
 site_recommendation => 'Site recommendation',
    submission_saved => 'Your submission has been saved. You can <a href=\''.$cfg{pageurl}.'/topics.'.$cfg{ext}.'?op=write_news\'>write another article</a> or you can <a href=\''.$cfg{pageurl}.'/index.'.$cfg{ext}.'\'>view the latest articles</a>.',
           thank_you => 'Thank you!',

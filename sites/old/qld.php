...
Queensland Branch Coordinator <br>
Mars Society of Australia <br>
<script> email('qld','marssociety.org.au','email')</script>  <br>
...
<?php
$SQL="SELECT DATE_FORMAT(date, '%D %M, %Y') as newdate, headline, article, thumb_gallery, region FROM headlines WHERE region like '%Queensland%' ORDER BY date DESC";

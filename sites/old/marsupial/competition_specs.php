...
<br><br>
<b>1.2 Modes of Operation</b> - Several different operational regimes should be considered when approaching the rover design:
<br><br>
...
<br><br>
<b>2.1.3 Chassis / Frame</b> - The best approach is to obtain the frame of an existing vehicle. The frame type will be a function of the loaded weight and dimensions of the crew compartment.
<br><br>
...
<br><br>
<b>2.2.3 Fuel</b> - The rover must carry enough fuel to enable one - way travel of at least 200 miles (320 km).
<br><br>
<b>2.2.4 Speed!</b> - The rover must be capable of at least 20 mph (32km/hr) over "easy terrain".
<br><br>
<b>2.3 External fittings</b> - The following describes systems required to support exploration activity that may be integrated with the exterior structure of the rover.
<br><br>
<b>2.3.1 Crane</b> - Optional. A crane may be provided to assist in lifting of rock boxes or EVA equipment. It should be simple in design and allow operation from inside or out of the rover. It should have a clear radius of reach of at least 180 degrees around the rover.
<br><br>
<b>2.3.2 Winch</b> -Recommended. An electric or manual winch may be included. Its primary function will be to assist in removal of the rover from mud or other difficult categories of terrain. It may also help dislodge other vehicles or be used in movement of heavy equipment.
<br><br>
<b2.3.3 Detachable tools></b> - Optional. This is analogous to the various blades, grading devices and drills that can be fitted to a "Bob Cat" light construction vehicle. If it is desired to pursue this option, the tools, attachment locations and a place for stowage must be included in the design.
<br><br>
<b>2.3.4 Sample stowage</b> - Required. This is best if it is a open rack with a means of securing rock / sample boxes. An adequate analog for a rock box is a "Playmate Cooler" ice chest. Accommodation for no less than 6 boxes should be provided. The rack should be easily accessible by a person standing on grade.
<br><br>
...
<br><br>
<b>2.3.7 Manipulators</b> - Optional. This enables collection of samples from inside the rover. Manipulators must have access to rock boxes in the stowed condition. The manipulator work station must be separate from the drivers station.
<br><br>
...
<br><br>
<b>2.3.9 Communications</b> - Required. The rover must have mounting points for radio antennas for communications with EVA personnel and the Mars base. The nature of the precise communication system may be proposed by the individual teams, subject to approval by the review group.
<br><br>
<b>2.4 Internal fittings</b> - The following describes internal furnishings and systems necessary to support the crew.
<br><br>
<b>2.4.1 Life Support System</b>
<br><br>
...
<br><br>
<b>2.4.2.1 Food Preparation</b> - Adequate food storage and preparation facilities must be provided to support a 1 week field trip.
<br><br>
...
<br><br>
<b>2.4.5 Vehicle control</b> - A driver's station with excellent visibility must be provided. This station will have all controls and indicators necessary to control the vehicle and monitor systems. A secondary set of controls next to the main station are an option. If a docking port is used (see 2.1.5), and it is located at the rear of the vehicle, an additional control station must be provided that controls steering, power and braking. The ability to telerobotically control the rover is a very desirable option. This would enable relocation of the vehicle if all crew members were on EVA. Another option is autonomous operation enabling return of the vehicle to a designated point if the crew were incapacitated.
<br><br>
<b>3.0 Performance Requirements</b> - The following are the rover's desired performance characteristics:
<br><br>
<b>3.1 Speed</b> - 20 miles / hour over moderate terrain.
<br><br>
<b>3.2 Range</b> - 200 mile one - way trip. It must be remembered that the mission of this vehicle mandates that it stop and start with high frequency, with its engine or APU running constantly for 1 week. Consequently, most fuel will be dedicated to running systems and not attaining the maximum range.
<br><br>
<b>3.3 Vehicle mass</b> - 1500kg (3333.3lb). This is dry mass. The purpose of this limit is to see if this is a realistic target mass. Contrary findings, if rigorously supported, will be considered.
<br><br>
<b>3.4 Terrain</b> - Must have off - road clearance and capability and ability to negotiate roof terrain while maintaining speeds of at least 5 mph.
<br><br>
<b>3.5 Logistics</b> - Must be transportable via C-130 (Lockheed L-100) Hercules. This mandates a packed width of 9'-0" (2.7m), height of 8'-6" (2.6m) and length of no more than 24'-0" (7.3m). Means of folding, or use of inflatable systems may definitely be considered.
<br><br>
<b>3.6 Crew</b> - 2 crew members will be considered optimal. 3 crew members will be the maximum crew size allowable. This is a function of allowable mass and volume.
<br><br>
<b>4.0 Deadlines / Schedule</b>
<br><br>
Initiate formation of your teams as soon as possible. You should commence your work by conducting a detailed literature review. There have been numerous vehicle studies for the Moon, Mars and Terrestrial extreme environments. Try to review as much previous work as possible. Teams should be able to obtain much of this information on line and at University Libraries. Check data bases for the American Institute of Aeronautics and Astronautics (<a href="http://www.aiaa.org">www.aiaa.org</a>), Society of Automotive Engineers (<a href="http://www.sae.org">www.sae.org</a>), American Society of Civil Engineers (<a href="http://www.asce.org">www.asce.org</a>) and The Journal of the British Interplanetary Society. Rigorously search NASA technical data bases. All teams should obtain a copy of the Manned - Systems Integration Standards (NASA - STD - 3000). It can be ordered on line from Johnson Space Center, and is also available on line (it is free!). This is now the standard human factors "configuration control document".
<br><br>
After you arrive at a coherent design idea, prepare an outline based on this specification. It should be as brief as possible, but include diagrams and sketches if you have them. Submit it electronically to Tom Hill no later than 1700 MDT, 5 May 2000. I will acknowledge receipt and forward your outlines to peer reviewers who will provide comments by 1700 MDT 19 May 2000. You will then have 11 weeks to complete your paper / proposal for presentation at the Mars Society Conference in Toronto. At the conference, the winning proposals will be named. It will then be time to begin detailed design!
<br><br>
Of course, if you have additional questions, please contact Tom Hill.<br><br>
Good Luck 	<br><br>

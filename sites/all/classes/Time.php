...
class Time {
  ...
  public function toArray() {
    ...
    $hours = floor($seconds / XDateTime::SECONDS_PER_HOUR);
    $seconds -= $hours * XDateTime::SECONDS_PER_HOUR;
    $minutes = floor($seconds / XDateTime::SECONDS_PER_MINUTE);
    $seconds -= $minutes * XDateTime::SECONDS_PER_MINUTE;
    return array(
      'hour'   => $hours,
      'minute' => $minutes,
      'second' => $seconds,
  ...
  public function time($hour = 0, $minute = 0, $second = 0) {
    if (func_num_args() == 0) {
      ...
      // Set the time:
      $this->seconds = ($hour * XDateTime::SECONDS_PER_HOUR) + ($minute * XDateTime::SECONDS_PER_MINUTE) + $second;
      return $this;
    }
  }
  ...
  public function minutes() {
    return $this->seconds / XDateTime::SECONDS_PER_MINUTE;
  }
  ...
  public function hours() {
    return $this->seconds / XDateTime::SECONDS_PER_HOUR;
  }
  ...
  public function days() {
    return $this->seconds / XDateTime::SECONDS_PER_DAY;
  }
  ...
  public function format($format) {
    // Easy way is to use XDateTime::format().
    $dt = new XDateTime();
    $dt->time($this);
